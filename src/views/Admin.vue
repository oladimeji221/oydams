...
async function toggleAvailability(product) {
  ...
  if (error) message.value = error.message
  else { product.available = available; message.value = `${product.name} is now ${available ? 'available' : 'unavailable'}.` }
}
