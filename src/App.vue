...
<template>
  <header class="site-header">
    ...
    <nav :class="{ open: menuOpen }">
      <a href="/#shop" @click="menuOpen = false">Our treats</a>
  ...
  <footer id="contact">
    <div class="footer-main">
      ...
      <div class="footer-column"><h3>Explore</h3><a href="/#shop">Our products</a><a href="/#about">About Oydam’s</a><a href="/#gallery">Our gallery</a><router-link to="/login">Admin sign in</router-link></div>
